...
public class AttachDialogComponent
    extends BaseModal<AttachDialogComponent> {
  
  public AttachDialogComponent(FileUploadComponent fileUploadComponent,
  ...
  public static AttachDialogComponent create(FileUploadComponent fileUploadComponent,
                                             CompleteHandler onCompletehandler) {
    return new AttachDialogComponent(fileUploadComponent,
                                     onCompletehandler);
  }
